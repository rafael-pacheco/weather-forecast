...
(/** @lends <global> */function (window, document, undefined) {
	 ...
	 *    } );
        ...
        function _fnLog(settings, level, msg, tn) {
            message = 'DataTables warning: ' +
                (settings !== null ? 'table id=' + settings.sTableId + ' - ' : '') + message;
            ...
            if (!level) {
                ...
                _fnCallbackFire(settings, null, 'error', [settings, tn, message]);
